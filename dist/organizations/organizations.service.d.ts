...
export declare class OrganizationsService {
    ...
    createOrganization(userId: string, createOrganizationDto: CreateOrganizationDto): Promise<void>;
    ...
    getOrganization(userId: string, organizationId: string): Promise<any>;
    updateOrganization(userId: string, organizationId: string, updateOrganizationDto: UpdateOrganizationDto): Promise<any>;
    updateOrganizationSettings(userId: string, organizationId: string, updateSettingsDto: UpdateOrganizationSettingsDto): Promise<any>;
    getOrganizationSettings(userId: string, organizationId: string): Promise<any>;
